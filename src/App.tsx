...
import { Text, Flex, Box, Heading, Container, Divider, Input, Button, ModalOverlay, Modal, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, useDisclosure , useToast } from "@chakra-ui/react";
...
const App: FC = () => {
  ...
  const verify = () => {
    ...
    authentication(userName , password).then(element => {
      setLoginState(element);
